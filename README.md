...
Download the repo as you will be uploading it onto Google Drive when going through the Colab Notebook.
The colab notebook is simply our project report which includes all the pip installs necessary to run the code, how to use deepmoji for transfer learning and how it compares to a pre-trained BERT model using Twitter and Youtube data.
